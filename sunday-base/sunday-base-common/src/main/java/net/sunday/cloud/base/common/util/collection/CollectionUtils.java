package net.sunday.cloud.base.common.util.collection;
...
public class CollectionUtils {
    ...
    public static <T, V extends Comparable<? super V>> V getMaxValue(Collection<T> from, Function<T, V> valueFunc) {
        ...
        return from.stream().max(Comparator.comparing(valueFunc)).map(valueFunc).orElse(null);
    }
    ...
    public static <T, V extends Comparable<? super V>> V getMinValue(List<T> from, Function<T, V> valueFunc) {
        ...
        return from.stream().min(Comparator.comparing(valueFunc)).map(valueFunc).orElse(null);
    }
